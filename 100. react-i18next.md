...
## HOOK, useTranslation, { t, i18n }  - in function component
...
## NOT SURE: Trans component - to deal with interpolation (not sure about this part, eventually I didn't use it)
...
```
// eg. if we deploy to gh-pagh, then the url:
original: /dieta/activityTableData/${i18n.language}.json
absolute: fetch(`https://yuwengithub.github.io/dieta/activityTableData/${i18n.language}.json`)
```
