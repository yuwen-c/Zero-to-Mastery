...
## Droppable , id, provided and snapshot
...
```
### return a function with (provided, snapshot)
...
## Draggable, id,  provided and snapshot
...
<Draggable/>
```
- directly apply ref and other props to out DOM.
```js
<div 
  ref={provided.innerRef}
  {...provided.draggableProps}   // draggable
  {...provided.dragHandleProps}  // dragHandle
    <div className="f3">
        {item.content}
    </div>
</div>
