...
# [2,3,4] => return [2,3,5]; [7,8,9] => return [7,9,0]
...
## 卡最久的，一直以為要用recursion，結果，其實用for去做就好了，我一直想，for()裡面，有if/else判斷是否>9，...然後要一直做下去，這樣就很像樹狀結構，就
**癥結點：要有意識地使用for，跟確知它每一輪迭代了什麼，還有每一輪產出了什麼**

## for 與 return的關係和解題邏輯



## 需要造一個array可以用什麼方法？new, from, concat. 
（還有我之前，想要造一個array = [1,2,3,4,5,6,7]的方法，要再查）
